...
<body>
  <section class="header-box fixed-bar bg-success ">

    <span style="font-size:30px;cursor:pointer; color: rgb(255, 255, 255); float: left;" onclick="openNav()">☰ </span>
    <h2 class="brand"><a href="index.php"> Ri<span style="color: blue">qq</span> conk </a></h2>
  ...
  <div id="mySidenav" class="sidenav">
    ...
    <div class="main-side-container">
      <div>
        ...
        <a href="category.php?catid=16"> Politics</a>
        <a href="category.php?catid=17"> Trending</a>
        <a href="category.php?catid=19"> Business</a>
        <a href="category.php?catid=22"> Entertainment</a>
      </div>
      <div>
        <a href="javascript:void(0)"></a>
        <a href="javascript:void(0)"></a>
        <a href="javascript:void(0)"></a>
        <a href="category.php?catid=28"> LifeStyle</a>
        <a href="category.php?catid=29"> Tech & Media</a>
        <a href="category.php?catid=20"> Education</a>
        <a href="category.php?catid=21"> Sports</a>
        <a href="category.php?catid=9"> Health</a>
        <a href="category.php?catid=23"> International</a>
        <a href="category.php?catid=12"> Biographies</a>
      </div>
      <div>
        <a href="javascript:void(0)" class="sub-side-container"> Crypto Currency</a>
        <hr>
        <a href="category.php?catid=23">Crypto News</a>
        <a href="category.php?catid=24">Coin Prices</a>
      </div>
      <div>
  ...
  <div class="row">
    <div class="side">
      <h5 class="categorytitlediff"><a href="category.php?catid=17" class="News-heading">TRENDING</a></h5>
      <div class="imgprops" style="height:auto;">
        ...
        ?>
          <h6 style="border-top: 2px solid white; color: grey;  font-family: Berlin Sans FB;">
            <svg viewBox="0 0 512 512" class="svg-clock"><!-- Font Awesome Free 5.15.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) -->
      ...
      <h3><a href="category.php?catid=21" class="News-heading">SPORTS</a></h3>
      <div class="imgprops" style="height:auto;">
      ...
      <h2><a href="category.php?catid=22" class="News-heading">ENTERTAINMENT</a></h2>
      <div class="imgprops" style="height:auto;">
        <!-- Blog Post -->
        <?php
        if (isset($_GET['pageno'])) {
    ...
    <div class="side">
      ...
      <h6 style="border-top: 2px solid white; color: grey;  font-family: Berlin Sans FB;"><svg viewBox="0 0 512 512" class="svg-clock"><!-- Font Awesome Free 5.15.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) -->
          <path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8zm0 448c-110.5 0-200-89.5-200-200S145.5 56 256 56s200 89.5 200 200-89.5 200-200 200zm61.8-104.4l-84.9-61.7c-3.1-2.3-4.9-5.9-4.9-9.7V116c0-6.6 5.4-12 12-12h32c6.6 0 12 5.4 12 12v141.7l66.8 48.6c5.4 3.9 6.5 11.4 2.6 16.8L334.6 349c-3.9 5.3-11.4 6.5-16.8 2.6z" />
        </svg> just now</h6>
      <div class="imgprops" style="height:auto;">
        ...
        <div style="height:433px; background-color: #1D2330; overflow:hidden; box-sizing: border-box; border: 1px solid #282E3B; border-radius: 4px; text-align: right; line-height:14px; font-size: 12px; font-feature-settings: normal; text-size-adjust: 100%; box-shadow: inset 0 -20px 0 0 #262B38; padding: 0px; margin: 0px; width: 100%;">
          <div style="height:413px; padding:0px; margin:0px; width: 100%;"><iframe src="https://widget.coinlib.io/widget?type=full_v2&theme=dark&cnt=6&pref_coin_id=1505&graph=yes" width="100%" height="409px" scrolling="auto" marginwidth="0" marginheight="0" frameborder="0" border="0" style="border:0;margin:0;padding:0;"></iframe></div>
