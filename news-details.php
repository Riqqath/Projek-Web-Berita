...
<head>
  ...
  <title>Riqq-Conk | News Detail</title>
...
<body>
  ...
  <section class="header-box fixed-bar bg-success">
    ...
    <ul class="top-nav">
      <a href="index.php">
        <li class="nav" id="c-color"> Home </li>
      </a>
  ...
  <div id="mySidenav" class="sidenav">
    ...
    <div class="main-side-container">
      <div>
        ...
        <a href="category.php?catid=18"> Indonesia News</a>
      ...
      <div>
        ...
        <a href="category.php?catid=25">International</a>
        <a href="category.php?catid=26">Biographies</a>
      </div>
      <div>
